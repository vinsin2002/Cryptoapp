...
function Card() {
  return (
    <div className='bg-white h-20 w-full border-2 border-blue-900 sm:w-1/3 m-3 rounded-xl shadow-blue-900 shadow-xl flex items-center justify-evenly'>
        ...
        <div>
        <h1 className='text-2xl text-green-500'>+2.7%</h1>
        <h1 className='text-gray-500 '>1800000$</h1>
        </div>
    </div>
  )
}
